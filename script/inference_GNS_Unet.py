...
1. 073,  ds_patch = 8, autoreg
python script/inference_GNS_Unet.py \
    --exp_id 73 \
    --ds_patch 8 \
...
2. 073,  ds_patch = 8, autoreg, on test set 30 frames
python script/inference_GNS_Unet.py \
    --exp_id 73 \
    --ds_patch 8 \
    --pore_path ../data/rock/001_064_RobuGlass3_rec_16bit_abs_ShiftedDown18Left7_compressed.tif \
    ...
    --tif_dir ./data/tif_073_segmented_tifs_down8/ \
    --phy_dir ./data/073_final_down8_maxpool/ \
    --tag "cross_modality_testset120" \
    --t_start 120 \
    --num_frames 30 \


3. 072,  ds_patch = 8, autoreg
python script/inference_GNS_Unet.py \
    --exp_id 72 \
    --ds_patch 8 \
    --pore_path ../data/rock/001_064_RobuGlass3_rec_16bit_abs_ShiftedDown18Left7_compressed.tif \
...
4. 073,  ds_patch = 8, autoreg, noise_10
python script/inference_GNS_Unet.py \
    --exp_id 73 \
    --ds_patch 8 \
    --pore_path ../data/rock/001_064_RobuGlass3_rec_16bit_abs_ShiftedDown18Left7_compressed.tif \
    --stats_path /gpfs/home/cw1722/particle/pore_net/data/supersmoothed_train_stats.pt \
    --file_name ../data/Velocity_smooth/073_final.csv \
    --model_path_gns ./out/GNS_noise_0.1_073_ds8/latest_checkpoint.pt \
    --model_path_unet ./out/04-20_11:58:32_tif_073_segmented_tifs_down8_bs2_lr0.001_ep100_fp16_in2_out1/checkpoint_epoch_100.pth \
    --n_frames_in 2 \
    --n_frames_out 1 \
    --channel_per_frame 4 \
...
5. 073,  ds_patch = 8, autoreg, noise_5, non-smoothed
python script/inference_GNS_Unet.py \
    --exp_id 73 \
    --ds_patch 8 \
    --pore_path ../data/rock/001_064_RobuGlass3_rec_16bit_abs_ShiftedDown18Left7_compressed.tif \
    --stats_path /gpfs/home/cw1722/particle/pore_net/data/supersmoothed_train_stats.pt \
    --file_name ../data/Velocity/073_RobuGlass3_drainage_174nl_min_run5_velocityPoints_surface_masked.csv \
    --model_path_gns ./out/GNS_noise_0.1_073_ds8_unsmoothed/latest_checkpoint.pt \
    --model_path_unet ./out/04-20_11:58:32_tif_073_segmented_tifs_down8_bs2_lr0.001_ep100_fp16_in2_out1/checkpoint_epoch_100.pth \
    --n_frames_in 2 \
    --n_frames_out 1 \
    --channel_per_frame 4 \
...
6. 073,  ds_patch = 8, autoreg - no image encoder
python script/inference_GNS_Unet.py \
    --exp_id 73 \
    --ds_patch 8 \
    --pore_path ../data/rock/001_064_RobuGlass3_rec_16bit_abs_ShiftedDown18Left7_compressed.tif \
    --stats_path /gpfs/home/cw1722/particle/pore_net/data/supersmoothed_train_stats.pt \
    --file_name ../data/Velocity_smooth/073_final.csv \
    --model_path_gns ./out/GNS_noise_0.05_073_ds8_smoothed_no_img_encoder/latest_checkpoint.pt \
    --model_path_unet ./out/04-20_11:58:32_tif_073_segmented_tifs_down8_bs2_lr0.001_ep100_fp16_in2_out1/checkpoint_epoch_100.pth \
    --n_frames_in 2 \
    --n_frames_out 1 \
    --channel_per_frame 4 \
...
7. 072,  ds_patch = 8, autoreg long rollout
python script/inference_GNS_Unet.py \
    --exp_id 72 \
    --ds_patch 8 \
    --pore_path ../data/rock/001_064_RobuGlass3_rec_16bit_abs_ShiftedDown18Left7_compressed.tif \
    ...
    --tif_dir ./data/tif_072_down8_interpolated/ \
    --phy_dir ./data/072_final_down8_maxpool/ \
    --tag "autoreg_072_long_100_80" \
    --t_start 100 \
    --num_frames 80 \

8. 073,  ds_patch = 8, autoreg test_maxpool
python script/inference_GNS_Unet.py \
    --exp_id 73 \
    --ds_patch 8 \
    --pore_path ../data/rock/001_064_RobuGlass3_rec_16bit_abs_ShiftedDown18Left7_compressed.tif \
    ...
    --tif_dir ./data/tif_073_segmented_tifs_down8/ \
    --phy_dir ./data/073_final_down8_maxpool/ \
    --tag "cross_modality_test_maxpool" \
    --t_start 150 \
    --num_frames 30 \

9. 072,  ds_patch = 8, autoreg, get_acc
python script/inference_GNS_Unet.py \
    --exp_id 72 \
    --ds_patch 8 \
    --pore_path ../data/rock/001_064_RobuGlass3_rec_16bit_abs_ShiftedDown18Left7_compressed.tif \
    --stats_path /gpfs/home/cw1722/particle/pore_net/data/073_C5_r32_ar5_ds8/073_get_acc_ds8_5_stats.pt \
    --file_name ../data/Velocity_smooth/072_final.csv \
    --model_path_gns ./out/GNS_noise_0.05_073_ds8_acc/latest_checkpoint.pt \
    --model_path_unet ./out/04-20_11:58:32_tif_073_segmented_tifs_down8_bs2_lr0.001_ep100_fp16_in2_out1/checkpoint_epoch_100.pth \
    --n_frames_in 2 \
    --n_frames_out 1 \
    --channel_per_frame 4 \
    ...
    --tif_dir ./data/tif_072_down8_interpolated/ \
    --phy_dir ./data/072_final_down8_maxpool/ \
    --tag "autoreg_072_long_100_80_acc" \
    --t_start 100 \
    --num_frames 80 \
    --get_acc \
"""
...
config = {
    ...
    "image_encoder": "cnn",
    "image_size": 32,
    "noise_scale": None,  # No noise during inference
}
...
if args.tag == "no_img_encoder":
    config["image_encoder"] = "none"
...
if __name__ == "__main__":
    ...
    if args.get_acc:
        positions_list = [
            auto_input_data.x.reshape(-1, 11, 3)[:, 1, :].clone(),
            auto_input_data.x.reshape(-1, 11, 3)[:, 0, :].clone(),
        ]
    else:
        positions_list = [
    ...
    if not args.get_acc:
        ...
        past_velocity = auto_input_data.x[:, 6:-4].clone()
    ...
    with torch.no_grad():
        ...
        for i in np.arange(t_center, rollout_end):
            ...
            if not args.get_acc:
                ...
                auto_input_data.x[:, 6:-4] = past_velocity.clone()
            ...
            phy_info_t1 = phy_info_t1.to(device)
            if exp_id == 72:
                print("phy_info_t1 shape:", phy_info_t1.shape)
                phy_info_t1 = phy_info_t1[:, :, 64:, :, :]
            phy_arr.append(phy_info_t1)
            # Update tif data
